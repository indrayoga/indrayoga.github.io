...
description: langkah langkah untuk memasang SSL di server zimbra.
date: 2025-07-08 08:45:00 +0800
pin: false
comments: true
categories: [Blog]
...
7. **Verifikasi Kecocokan Certificate dan Key**
   ...
   ```
   Jika hasilnya *match*, lanjut ke langkah berikutnya.
...
8. **Verifikasi Certificate Chain**
   ...
   ```
   Jika hasilnya *OK*, lanjut ke langkah berikutnya.
